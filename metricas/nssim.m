function [ssimval, ssimmap] = nssim(varargin)
...
if isa(ssimval,'gpuArray') 
    ssimval=gather(ssimval);
    clear mux2;
    clear sigmax2 ;
    clear sigmay2 ;
    clear sigmaxy;
...
validImageTypes = {'gpuArray','uint8','uint16','int16','single','double'};
